...
验证真实端到端链路，打向 https://your-cloud-agent.example.com，无 Mock。
...
用法:
    ...
    # 指定云端 URL
    CLOUD_URL=https://your-cloud-agent.example.com python -m pytest tests/test_cloud_agent_e2e.py -v
"""
...
CLOUD_URL = os.environ.get("CLOUD_URL", "https://your-cloud-agent.example.com")
