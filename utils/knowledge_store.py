...
class KnowledgeStore:
    ...
    async def touch_user(self, user_id: str, metadata: Optional[Dict[str, Any]] = None) -> None:
        ...
        await self.store.update_async(_mutate)
    ...
    async def get_conversation(self, conversation_id: str) -> Optional[Dict[str, Any]]:
        """读取 conversation 信息。"""
        data = await self.store.read_async()
    ...
    async def update_document_status(self, user_id: str, document_id: str, status: str) -> None:
        """更新文档状态"""
    ...
    async def delete_document(self, user_id: str, document_id: str) -> None:
        ...
        def _mutate(data: Dict[str, Any]):
            ...
            documents = user.get("documents", [])
            user["documents"] = [doc for doc in documents if doc.get("document_id") != document_id]
...
def create_knowledge_store(data_dir: str = None) -> KnowledgeStore:
    ...
    return KnowledgeStore(
        store=JsonFileStore(path=path, default_factory=create_default_knowledge_store_dict)
    )
