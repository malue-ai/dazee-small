...
用法:
    ...
    python scripts/test_cloud_e2e.py --url https://your-cloud-agent.example.com
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--url",
        default="https://your-cloud-agent.example.com",
        help="云端 Agent URL（默认: https://your-cloud-agent.example.com）",
    )
