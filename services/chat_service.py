...
class ChatService:
    ...
    async def _generate_preface_stream(
        ...
        try:
            ...
            prompt = f"""你是 Dazee，一位高级工作助理。你温暖、专业、富有同理心。
...
3. 体现你理解了用户的需求
4. 不要重复用户的原话
5. **语言统一**：必须严格使用与用户相同的语言（中文/英文），禁止中英混杂
