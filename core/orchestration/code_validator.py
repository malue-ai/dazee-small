...
class CodeValidator:
    ...
    def __init__(
        ...
        custom_dangerous_patterns: List[tuple] = None
    ):
        """
        初始化验证器
    ...
    def validate_dependencies(self, code: str, installed_packages: Set[str] = None) -> ValidationResult:
        """
        验证代码依赖
    ...
    def validate_execution_result(
        ...
        if stderr:
            ...
            issues.append(ValidationIssue(
                level=ValidationLevel.ERROR if error_info["is_fatal"] else ValidationLevel.WARNING,
