...
替代方案：
- 使用 agent_v3.tools.plan_todo_tool.PlanTodoTool
- 使用 agent_v3.core.memory.WorkingMemory 的 plan_json/todo_md 属性
...
迁移指南：
1. 将 `from agent_v3.core.planning import PlanningManager` 
   改为 `from agent_v3.tools.plan_todo_tool import create_plan_todo_tool`
