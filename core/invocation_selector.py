...
class InvocationSelector:
    ...
    def get_tools_config(
        ...
        if strategy.type == InvocationType.TOOL_SEARCH:
            ...
            return {
                ...
                "betas": ["code-execution-2025-05-22"]  # Beta header
            }
        
        elif strategy.type == InvocationType.PROGRAMMATIC:
            # Programmatic 模式（在 code_execution 内调用工具）
            return {
                "tools": all_tools,
    ...
    def _configure_tool_search(
        ...
        configured_tools.append({
            "type": "tool_search_tool_bm25_20251119",  # 或 regex
        ...
        return {
            ...
            "betas": ["advanced-tool-use-2025-11-20"]  # Tool Search Beta
        }
