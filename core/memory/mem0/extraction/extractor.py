...
{{
  ...
  "identity_hint": {{
    "name": "用户的姓名或称呼（如果提到，如：小王、张三、Alex）或 null",
    "role": "职业角色（如：产品经理、前端开发、设计师、运营）或 null",
    "company": "公司/团队/组织（如果提到）或 null",
    "location": "所在地（如：深圳、上海、北京、杭州）或 null",
    "expertise_level": "专业水平（beginner/intermediate/expert）或 null",
    "other_traits": ["其他身份特征（如：自由职业者、创业者、在读研究生）"],
    "confidence": 0.0-1.0
  }}
}}
```
...
8. 目标可以从用户的表述和意图中推断
9. 身份信息需要从自我介绍、对话上下文中推断（如"我是做产品的"→role="产品经理"）
10. 只输出 JSON，不要其他解释
