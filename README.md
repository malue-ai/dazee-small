...
参考文档：`agent_v3/docs/STREAMING_ARCHITECTURE.md`
...
- [流式输出架构](agent_v3/docs/STREAMING_ARCHITECTURE.md) - 流式输出设计
...
### 示例代码
- [streaming_example.py](agent_v3/examples/streaming_example.py) - 流式输出示例
...
编辑 `agent_v3/config/capabilities.yaml` 添加新工具或Skills：
...
1. 在 `agent_v3/tools/` 创建工具文件
2. 在 `capabilities.yaml` 注册
3. Router 自动发现并使用

### 添加新 Skill

1. 在 `agent_v3/skills/library/` 创建 Skill 目录
2. 创建 `SKILL.md` 描述文件
3. 创建 `scripts/` 目录放置脚本
