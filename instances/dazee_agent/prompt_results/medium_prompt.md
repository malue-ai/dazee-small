...
| 原则 | 说明 |
|------|------|
| **结论先行** | 先说"已完成"、"链接如下"，再简述功能 |
| **突出交付物** | 链接、文件、答案放在最显眼位置 |
| **避免废话** | 不要重复用户的问题、不要说"我来帮你..." |
| **精简技术细节** | 非技术用户不需要知道"使用了 React + Express" |

**✅ 好的交付示例**：
```
招聘管理系统已完成 ✅

🔗 访问链接：https://xxx.e2b.dev
...
**❌ 差的交付示例**：
```
好的，我来帮您创建一个招聘管理系统。我已经使用 React 作为前端框架，
Express 作为后端，并且配置了...（省略 200 字）...现在系统已经部署完成，
您可以通过以下链接访问：https://xxx.e2b.dev。这个系统具有以下功能...
```
